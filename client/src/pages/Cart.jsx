  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        return (
          <DeleteOutlined
            onClick={() => handleRemoveCartItem(record.key)}
          ...
          <Col span={12} className="p-4 shadow-lg">
            ...
            <Row gutter={24} className="mt-8">
              <Col span={12}>
                <Image
                  ...
                  className={`border ${
                    payment ? "border-purple-500" : "border-blue-300 "
                  } cursor-pointer hover:border-purple-500 rounded-md p-2`}
                  height={150}
                  src={vnpaylogo}
                  preview={false}
                />
            ...
            <Row className="mt-8">
              <Form className="w-full" layout="vertical">
                <Form.Item
                  label={
                    <Typography.Title level={5}>Name on card</Typography.Title>
                  }
                  name="name"
                  rules={[
                    {
                ...
                <Form.Item
                  label={
                    <Typography.Title level={5}>Card number</Typography.Title>
                  }
                  name="card"
                  rules={[
                    {
