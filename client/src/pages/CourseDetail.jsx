...
import {Avatar, Button, Col, Collapse, ConfigProvider, Flex, Image, Rate, Row, Space, Tabs, Typography} from 'antd'
import {
    BarsOutlined,
    BgColorsOutlined,
    CalculatorOutlined,
    ...
    return (
        <Space direction='vertical'>
            ...
            <Typography.Paragraph style={{color: '#676C7D'}}>
                ...
                sophisticated Single-Page Applications when used in combination with modern tooling and supporting
                libraries.
            ...
            <Typography.Paragraph>
                <ul>
                    <li>
                        <Typography.Link className='text-base' style={{color: '#676C7D'}}
                                         href="/docs/spec/proximity">Principles</Typography.Link>
                    </li>
                    <li>
                        <Typography.Link className='text-base' style={{color: '#676C7D'}}
                                         href="/docs/spec/overview">Patterns</Typography.Link>
                    </li>
                    <li>
                        <Typography.Link className='text-base' style={{color: '#676C7D'}} href="/docs/resources">Resource
            ...
            <Row className='mb-4 pb-4 border-b'>
                ...
                <Col span={18}>
                    <div className='text-base'>
                        From the outset, the course structure impressed me with its thoughtful organization. Each module
                        builds seamlessly upon the last, creating a logical and comprehensive learning journey. The
                        content is delivered in a way that is both engaging and accessible, making complex concepts easy
                        to grasp.
                    </div>
                </Col>
            </Row>
        ...
        <Space direction='horizontal'>
            ...
            <Space direction='vertical' className='ml-6'>
                ...
                <Typography.Text className='text-line-2'>
                    Sharing is who I am, and teaching is where I am at my best, because I've been on both sides of that
                    equation, and getting to deliver useful training is my meaningful way to be a part of the creative
                    community.I've spent a long time watching others learn, and teach, to refine how I work with you to
                    be efficient, useful and, most importantly, memorable. I want you to carry what I've shown you into
                    a bright future.I have a wife (a lovely Irish girl) and kids. I have lived and worked in many places
                    (as Kiwis tend to do) – but most of my 14+ years of creating and teaching has had one overriding
                    theme: bringing others along for the ride as we all try to change the world with our stories, our
                    labours of love and our art.I'm a certified Adobe instructor (ACI) in Ireland. I'm also an Adobe
                    Certified Expert (ACE) and have completed the Adobe Certified Associate training (ACA). And I don't
                    just do Adobe. Remember, media is a very broad term – digital blew out the borders, so we are all
                    constantly learning.I've been teaching for 14+ years. I come from being a media designer and content
                    creator – so I understand exactly where you're at now. I've been there. I love this stuff. Print,
                    digital publishing, web and video. I can see how it all connects. And I can see how we can share
                    those connections.I built Bring Your Own Laptop in Ireland, New Zealand, Australia & online. I have
                    a great team working with me to keep BYOL at the top of Adobe and digital media training. I
                    understand business, I have one – so I know how important it is to get it right and make it work for
                    you.Now my focus is on Udemy. It's my mission to bring you the best training for digital media on
                    Udemy.
                </Typography.Text>
                <Flex gap="small" className='mt-6'>
                    ...
                    <Button className='bg-[#754FFE]' type='primary' size='normal' onClick={() => navigate('/instructor/' + instructorId)} >View profile</Button>
                </Flex>
            </Space>
        </Space>
    )
        ...
        <>
            <section style={{backgroundImage: `url(${breadcramb})`}} className="my-6 py-12">
                <Row className="max-w-screen-xl m-auto">
                    <Space direction='vertical'>
                        <Typography.Title style={{color: 'white'}}>{course.data.title}</Typography.Title>
                        <Typography.Text
                            style={{color: 'white', fontSize: '18px'}}>{course.data.shortDes}</Typography.Text>
                        <Flex align='center' justify='space-between' className='my-2'>
                            <Space>
                                <Avatar src="https://api.dicebear.com/7.x/miniavs/svg?seed=1"/>
                                <span className='text-white text-sm'>Created by <Typography.Link
                                    style={{color: 'white', fontSize: '16px'}}>John Doe</Typography.Link> </span>
                            </Space>
                            <Space>
                        ...
                        <div className='shadow-lg rounded-md sticky mt-[-200px]'>
                            <Space direction='vertical' className='p-2'>
                                <Space className='relative' style={{columnGap: 0}}>
                                    <div
                                        className='absolute p-2 rounded-lg cursor-pointer top-[calc(50%-16px)] left-[calc(50%-16px)] bg-[#0000005a]'>
                                        <PlayCircleOutlined className='text-3xl text-white'/>
                                    </div>
                                    <img src={item1} alt="image" className='w-full h-[227px] rounded-lg'/>
                                    <div
                                        className="bg-white absolute top-3 right-5 w-6 h-6 flex items-center justify-center rounded-full">
                                        <HeartFilled className="text-[#6e798a81]"/>
                                    </div>
                                </Space>
                                <div className='p-4 w-full'>
                                    <Flex align='center' className='w-full'>
                                        <h1 className='font-semibold text-3xl mr-4'>{!course.data.price ? "Free" : course.data.price.toLocaleString() + " VND"}</h1>
                                ...
                                <div className='p-3 w-full'>
                                    ...
                                    >
                                        <Button icon={<PlusOutlined/>} size='large'
                                                className='w-full bg-[#F8F7FF] text-purple-500 font-semibold border-purple-500 mb-6'>Add
                                            to cart</Button>
                                        <Button icon={<CreditCardOutlined/>} size='large'
                                                className='w-full bg-[#F8F7FF] text-purple-500 font-semibold border-purple-500'>Buy
                                            now</Button>
                                    </ConfigProvider>
                                </div>
                            </Space>
