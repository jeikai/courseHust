...
import {
    ArrowRightOutlined,
    Html5Filled,
    JavaOutlined, JavaScriptOutlined,
    LeftOutlined, PythonOutlined,
    RightOutlined, RubyOutlined,
    SearchOutlined
        ...
        <>
                        ...
                        <div className="mt-12">
                            <form action="">
                                <Space.Compact style={{width: '90%'}} className="bg-[#F8F7FF] p-1 border">
                                    ...
                                    <Button size="large" type="primary" className="bg-[#754FFE]"
                                            icon={<SearchOutlined/>}>
                                        Search
                                    </Button>
                                </Space.Compact>
                    ...
                    <Col span={8}>
                        <Flex gap={12} align="center" className="p-4 px-8 cursor-pointer border-r-2">
                            ...
                            <Space direction="vertical" gap="0">
                                ...
                                <Typography.Text className="text-base">Explore a variety of fresh
                                    topics</Typography.Text>
                            </Space>
                        </Flex>
                    </Col>
                    <Col span={8}>
                                ...
                                <Col span={6} key={index}>
                                    <Space direction="vertical"
                                        ...
                                        <a href="" className="mb-8 block">
                                            <category.icon
                                                className="p-2 text-xl group-hover:text-white group-hover:border-white text-[#FB6871] border-2 border-[#FB6871] rounded-full"/>
                                        </a>
                                        ...
                                        <a href="" className="block mt-4 pb-6">
                                            <ArrowRightOutlined
                                                className="text-xl font-bold group-hover:text-white text-[#FB6871]"/>
                                        </a>
                                    </Space>
                                </Col>
                            )
            ...
            <section className="max-w-screen-xl m-auto">
                ...
                <div className="my-6 relative">
                    <Button onClick={() => carousel1.current.prev()} className="absolute top-1/2 -left-6 z-10 bg-white"
                            shape="circle" icon={<LeftOutlined className="text-[#754FFE]"/>} size="large"/>
                    ...
                    <Button onClick={() => carousel1.current.next()} className="absolute top-1/2 -right-6 z-10 bg-white"
                            shape="circle" icon={<RightOutlined className="text-[#754FFE]"/>} size="large"/>
                </div>
            </section>
            <section className="max-w-screen-xl m-auto mt-24">
                ...
                <div className="my-6 relative">
                    <Button onClick={() => carousel2.current.prev()} className="absolute top-1/2 -left-6 z-10 bg-white"
                            shape="circle" icon={<LeftOutlined className="text-[#754FFE]"/>} size="large"/>
                    ...
                    <Button onClick={() => carousel2.current.next()} className="absolute top-1/2 -right-6 z-10 bg-white"
                            shape="circle" icon={<RightOutlined className="text-[#754FFE]"/>} size="large"/>
                </div>
            </section>
            <section className="max-w-screen-xl m-auto mt-24">
                ...
                <Row className="mb-12">
                    ...
                    <Col span={16}>
                        <Flex align="center" gap={16}>
                            ...
                            <div>
                                <h4 className="text-2xl font-bold text-[#1e293b] mb-5">"Unleashing Your Inner
                                    Champion"</h4>
                                <p className="text-base font-normal text-[#676c7d]">Embrace your untapped potential,
                                    push your limits, and unlock the champion within you. This motivational title
                                    encourages you to tap into your inner strength, overcome obstacles, and strive for
                                    excellence in all areas of your life.</p>
                            </div>
                        </Flex>
                    </Col>
                </Row>
                <Row className="mb-12">
                    <Col span={16} className="pl-10">
                        <Flex align="center" justify="flex-end" gap={16}>
                            ...
                            <div>
                                <h4 className="text-2xl font-bold text-[#1e293b] mb-5">"Embracing the Journey of
                                    Growth"</h4>
                                <p className="text-base font-normal text-[#676c7d]">Life is a constant journey of growth
                                    and self-improvement. This motivational title reminds you to embrace challenges,
                                    learn from failures, and celebrate successes along the way. Embrace the journey of
                ...
                <Row className="mb-12">
                    ...
                    <Col span={16}>
                        <Flex align="center" gap={16}>
                            ...
                            <div>
                                <h4 className="text-2xl font-bold text-[#1e293b] mb-5">"Igniting the Spark of
                                    Possibility"</h4>
                                <p className="text-base font-normal text-[#676c7d]">Within each of us lies a spark of
                                    possibility waiting to be ignited. This motivational title inspires you to dream
                                    big, believe in yourself, and pursue your passions with unwavering
                                    determination.</p>
                            </div>
                        </Flex>
                    </Col>
