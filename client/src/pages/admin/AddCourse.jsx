                    ...
                    <div className='bg-[#f1f5f9] p-2 rounded-md mb-4'>
                        <Flex vertical gap={12}>
                            {data?.sections.map(section => {
                                return (
                                    <div key={section.id} style={{ border: '1px solid #e2e8f0' }} className="item rounded text-nowrap bg-white text-[#64748b] p-4">
                                        <Flex align='center' justify='space-between' className='mb-4'>
                                            ...
                                            <Space className='text-base'>
                                                ...
                                                {section?.specials?.map((item) => {
                                                    return (
                                                        <Flex key={item.id} className='border px-4 p-2 mb-3 bg-[#f1f5f9]' align='center' justify='space-between'>
